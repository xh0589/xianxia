...
var src = fs.readFileSync(path.join(__dirname, '..', 'js/crafting/forging-compound.js'), 'utf8');
...
var r_attack = F.executeCompoundForging('recipe_sword_open', { embryo:'sword', main:['mat_star_iron'], assist:['mat_mithril','mat_meteorite'], rune:[] });
