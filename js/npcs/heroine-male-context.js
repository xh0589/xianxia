...
//
// 修罗宫男线（苛刻破例）：原设计「只收受情伤女子」明规矩拒男，但绯泪有条不成文破例——
//   凡「为世道所不容、情伤至深」的男子（恶名≥25）可求见宫主，受寒冰+情蛊双试炼
//   （意志≥40 且 真气上限≥80，sect-join-flow.js xiuluoMaleTrialAttempt/Resolve）。
//   通过 → 以「试情弟子」入派，绯泪主线对其开放；不通过 → 反噬扣血、可他日再试。
//   入门处守卫有提示（不死路）。故男玩家亦可恋绯泪，但门槛远高于女玩家正常考核。
