...
(function () {
    ...
    // ============== 2. 灵兽园配置 ==============
    var GARDEN_COST = 100;
    var GARDEN_REFUND_RATE = 0.5;  // v20.0：拆园退款率
    ...
    function _payGardenCost(cost, skipPay) {
        ...
        if ((inv.spiritStones || 0) < cost) {
            return { ok: false, reason: 'spiritStones-low', need: cost, have: inv.spiritStones || 0 };
        }
    ...
    function build(sectId, opts) {
        ...
        // v20.0：一宗一园（除非 allowMultiple 显式绕过）
