...
var LOCATION_TRANSITIONS = {
    ...
    '凤凰巢': { enter: '热浪扑面，火山口上赤羽翻飞——一声凤鸣，整座巢城都在震颤。', bg: 'from-orange-900/50 to-red-900/40' },
    '佛国遗址': { enter: '黄沙半埋着倾颓的塔林，风穿过残洞，呜呜声竟似诵经。', bg: 'from-amber-900/40 to-yellow-950/40' },
    '万剑宗': { enter: '漫山剑林直立如碑，你的佩剑在鞘中轻轻震颤——是万剑在点名。', bg: 'from-slate-900/50 to-cyan-950/40' },
